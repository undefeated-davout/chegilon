...
ActiveRecord::Schema.define(version: 20170505072555) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["user_id", "item_id", "created_at"], name: "index_comments_on_user_id_and_item_id_and_created_at"
  ...
  create_table "contact_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["output_number"], name: "index_contact_categories_on_output_number"
  end
  ...
  create_table "item_stocks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id", "user_id"], name: "index_item_stocks_on_item_id_and_user_id", unique: true
    t.index ["item_id"], name: "index_item_stocks_on_item_id"
    t.index ["user_id"], name: "index_item_stocks_on_user_id"
  end
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["create_user_id", "update_user_id", "updated_at"], name: "item_by_create_update_user"
  ...
  create_table "opinions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_opinions_on_created_at"
  end
  ...
  create_table "tag_follows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tag_id", "user_id"], name: "index_tag_follows_on_tag_id_and_user_id", unique: true
